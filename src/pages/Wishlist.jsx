...
const Wishlist = () => {
  ...
  const handleRemove = (movie) => {
    ...
    toast.info(`"${movie.title || movie.name}" removed from wishlist.`);
  };
  ...
  return (
    <div className="max-w-[1300px] mx-auto px-10 py-10 font-sans min-h-[60vh]">
      ...
      <div className="flex justify-between items-center mb-8 border-b pb-4 border-gray-200">
        <div>
          <h2 className="text-[1.8rem] font-bold text-[#000] dark:text-white">
            My Wishlist
          </h2>
          {user && (
      ...
      {wishlist.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-gray-500">
          ...
          <p className="mb-8 text-gray-400">
            Start exploring and save your favourite movies for later!
          </p>
          <Link
            to="/"
